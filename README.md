...
Modern, lightweight Eleventy v4 multi-site starter showcasing [Eleventy Blades](https://11ty.blades.ninja/) and Tailwind CLI for: 1️⃣ Tailwind 2️⃣ [Pico](https://blades.ninja/css/pico/) 3️⃣ Simple CSS.
